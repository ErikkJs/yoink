...
The full source lives at <a href="https://github.com/ErikkJs/yoink/tree/master/src/yoink">github.com/ErikkJs/yoink/tree/master/src/yoink</a>. ~3,200 lines of Python across 18 files, each module focused, with 134 passing tests under `tests/`.
