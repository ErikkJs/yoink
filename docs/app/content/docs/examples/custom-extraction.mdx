...
[`examples/custom_extraction.py`](https://github.com/ErikkJs/yoink/blob/main/examples/custom_extraction.py) demonstrates lightweight post-processing — link-counting by domain, keyword search, metadata inspection. The recipes on this page go further (subclassing `Extractor`, parsing JSON-LD, handling PDFs).
</Callout>
...
- The default `Extractor`: <a href="https://github.com/ErikkJs/yoink/blob/main/src/yoink/extractor.py">src/yoink/extractor.py</a>.
- The default `Parser`: <a href="https://github.com/ErikkJs/yoink/blob/main/src/yoink/parser.py">src/yoink/parser.py</a>.
